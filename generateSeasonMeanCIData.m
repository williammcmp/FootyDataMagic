function [winningData, losingData, marginData] = generateSeasonMeanCIData(homeTeam, awayTeam, year)
    % GENERATESEASONMEANCIDATA - Generate mean and CI data for a specific season.
    %
    % Input:
